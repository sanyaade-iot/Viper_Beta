...
/* Internal Flash end memory address */ //For 128KB Internal Flash
#define INTERNAL_FLASH_END_ADDRESS  ((uint32_t)0x08020000)
...
void flash_clear(uint8_t *from, uint32_t size);

int flash_write(uint8_t *addr, uint8_t *data, uint32_t bytes);
