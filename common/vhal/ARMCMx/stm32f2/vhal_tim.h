...
//#define TICKS_PER_MUSEC(apb) (((apb)==1) ? ((_system_frequency/2)/1000000):((_system_frequency/2)/1000000))
//if apb1, then the frequency of timers is the freq of apb1=sysfreq/4 (mcuconf), but is multiplied by 2 if psc>1-->so is sysfreq/2
//if apb2, then the frequency of timers is the freq of apb2=sysfreq/2 (mcuconf), but is multiplied by 2 if psc>1--> sysfrq
#define TICKS_PER_MUSEC(apb) (((apb)==1) ? ((_system_frequency/2)/1000000):((_system_frequency)/1000000))
//tm starts from zero...
