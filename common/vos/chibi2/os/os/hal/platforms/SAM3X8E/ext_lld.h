 ...
 */
#define EXT_MAX_CHANNELS    EXT_INTERRUPTS_NEEDED
...
#define EXT_CHANNEL_CFG(port,pad,mode,cb) {(port),(pad),(mode),0,(cb)}
 ...
 *                      callback
 */
typedef void (*extcallback_t)(EXTDriver *extp, expchannel_t channel, int dir);
