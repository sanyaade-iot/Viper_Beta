...
TEST(timinput){
  ...
  vhalPwmStart(PWM7,  TIME_U(2, SECONDS),TIME_U(1, SECONDS));
...
TEST(allpwm) {
    ...
    // vhalPwmStart(PWM12,  TIME_U(6, SECONDS),TIME_U(5, SECONDS));
    // vhalPwmStart(PWM9,   TIME_U(6, SECONDS),TIME_U(4, SECONDS));
    // vhalPwmStart(PWM5,   TIME_U(6, SECONDS),TIME_U(3, SECONDS));
    ...
    /*if(vhalPwmStart(PWM14,  TIME_U(6, SECONDS),TIME_U(1, SECONDS)) != 0) printf("E1\n");
	vhalPwmStart(PWM14,  TIME_U(6, SECONDS),0);
	vhalPwmStart(PWM14,  TIME_U(6, SECONDS),TIME_U(5, SECONDS));*/
